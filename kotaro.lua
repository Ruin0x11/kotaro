...
function kotaro.file_to_ast(file)
   ...
   return kotaro.source_to_ast(src)
end

function kotaro.source_to_ast(src)
...
function kotaro.refactor_file(file, refactorings, opts)
   assert(type(file) == "string", "'file' must be a string")
   ...
   return edit_file(file, refactor_cst, opts)
end

function kotaro.refactor_source(src, refactorings, opts)
   assert(type(src) == "string", "'src' must be a string")
   ...
   return edit_src(src, refactor_cst, opts)
end
